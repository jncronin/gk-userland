...
cmake $CMAKE_OPTS -DUNIX=ON -DSDL_LIBC=ON -DSDL_PTHREADS=ON -DSDL_THREADS=ON -DSDL_OPENGL=OFF -DSDL_OPENGLES=OFF -DSDL_CLOCK_GETTIME=ON -DSDL_LOADSO=ON -S SDL2-2.28.5/ -B build-v4/sdl2
