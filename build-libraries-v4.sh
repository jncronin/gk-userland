...
mkdir -p build-v4/mpg123
cd build-v4/mpg123
../../mpg123-1.32.7/configure --host=aarch64-none-gkos --disable-static --enable-shared --with-cpu=aarch64 --with-audio=dummy --disable-modules --prefix=$SYSROOT/usr
make -j16 install
cd ../..
