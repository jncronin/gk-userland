...
int load_games()
{
    ...
    ADD_DEFINE(GK_STICK_THROTTLE_DETENT);
    ADD_DEFINE(GK_STICK_4WAY);
#endif
    ...
    ADD_DEFINE(GK_KEYLT);
    ADD_DEFINE(GK_KEYRT);
    ADD_DEFINE(GK_KEYSELECT);
    ADD_DEFINE(GK_KEYSTART);
    ...
    ADD_DEFINE(GK_THROTTLE_DETENT_0);
    ADD_DEFINE(GK_THROTTLE_DETENT_1);
    ADD_DEFINE(GK_THROTTLE_DETENT_2);
    ADD_DEFINE(GK_THROTTLE_DETENT_3);
    ADD_DEFINE(GK_THROTTLE_DETENT_4);
    ADD_DEFINE(GK_THROTTLE_DETENT_5);
    ADD_DEFINE(GK_THROTTLE_DETENT_6);
    ADD_DEFINE(GK_THROTTLE_DETENT_7);
    ADD_DEFINE(GK_THROTTLE_DETENT_8);
    ADD_DEFINE(GK_THROTTLE_DETENT_9);
    ADD_DEFINE(GK_THROTTLE_DETENT_10);
    ADD_DEFINE(GK_THROTTLE_DETENT_11);
    ADD_DEFINE(GK_THROTTLE_DETENT_12);
    ADD_DEFINE(GK_THROTTLE_DETENT_13);
    ADD_DEFINE(GK_THROTTLE_DETENT_14);

    ADD_DEFINE(GK_GAMEPAD_BUTTON);
    ADD_DEFINE(GK_MOUSE_BUTTON);
#endif
