...
set(C_CXX_FLAGS  "--specs=nano.specs -ffunction-sections -fdata-sections -ffreestanding -D__GAMEKID__ -D_POSIX_THREADS")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "-Wl,--gc-sections -L$ENV{HOME}/src/gk/lib -lm -Wl,--whole-archive $ENV{HOME}/src/gk/lib/libgloss-gk.a -Wl,--no-whole-archive"                           CACHE STRING "" FORCE)
